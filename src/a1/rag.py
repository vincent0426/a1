...
class Database:
    ...
    def __init__(self, connection: str, schema: Optional[str] = None):
        """
        Initialize Database.
...
class RAG:
    ...
    def __init__(self, filesystem: Optional[FileSystem] = None, database: Optional[Database] = None):
        """
    ...
    def get_toolset(self, name: str = "rag") -> ToolSet:
        ...
        return ToolSet(
            name=name,
            description="Readonly RAG toolset (file search and database queries)",
            tools=self.tools
        )
